...
struct R: Rswift.Validatable {
  ...
  struct storyboard {
    /// Storyboard `BleDevices`.
    static let bleDevices = _R.storyboard.bleDevices()
    ...
    #if os(iOS) || os(tvOS)
    /// `UIStoryboard(name: "BleDevices", bundle: ...)`
    static func bleDevices(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.bleDevices)
    }
    #endif
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct bleDevices: Rswift.StoryboardResourceType, Rswift.Validatable {
